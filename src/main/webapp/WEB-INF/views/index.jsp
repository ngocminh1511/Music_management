...
<div class="music-player-page">
    ...
    <div class="main-content" id="mainContent">
        ...
        <section>
            <h3 class="section-title">🔥 Top bài hát được nghe nhiều</h3>
        ...
        <section style="margin-bottom: 3rem;">
            <h3 class="section-title">🎧 Bài hát mới nhất</h3>
            <div class="carousel-container">
        ...
        <!-- Top Singers -->
        <section>
            <h3 class="section-title">⭐ Ca sĩ nổi tiếng</h3>
            <div class="carousel-container">
                        ...
                        <c:if test="${status.index < 10}">
                            <div class="artist-card artist-card-carousel" onclick="window.location.href='${pageContext.request.contextPath}/song/singer?id=${singer.id}'">
                                <img src="${pageContext.request.contextPath}${singer.avatar}" 
                                     class="artist-avatar" 
                                     alt="${singer.name}"
                                     onerror="this.src='${pageContext.request.contextPath}/assets/avatars/default.jpg'">
...
function loadPlaylistDetail(playlistId, playlistName) {
    ...
    // Show loading
    modePlaylist.innerHTML = '<div style="text-align: center; padding: 3rem; color: var(--text-primary);"><h3>⏳ Đang tải playlist...</h3></div>';
    ...
    fetch('${pageContext.request.contextPath}/playlist/view?id=' + playlistId)
        ...
        .catch(function(err) {
            ...
            modePlaylist.innerHTML = '<div style="text-align: center; padding: 3rem; color: #ff4444;"><h3>❌ Lỗi tải playlist</h3><p>Vui lòng thử lại</p></div>';
        });
}
